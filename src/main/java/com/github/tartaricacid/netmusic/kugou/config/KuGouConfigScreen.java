...
public final class KuGouConfigScreen {
    ...
    public static Screen create(net.minecraft.client.Minecraft client, Screen parent) {
        ...
        Component loginStatusComp = KuGouConfig.isLoggedIn()
                ? Component.translatable("netmusic_kugou.config.login.logged_in", KuGouConfig.userid)
                : Component.translatable("netmusic_kugou.config.login.not_logged_in");
        loginCat.addEntry(entryBuilder.startTextDescription(loginStatusComp).build());
        ...
        vipCat.addEntry(entryBuilder.startBooleanToggle(Component.translatable("netmusic_kugou.config.auto_receive_vip"), ClientConfig.AUTO_RECEIVE_VIP.get())
                ...
                .build());
        vipCat.addEntry(entryBuilder.startIntSlider(Component.translatable("netmusic_kugou.config.retry_interval"), ClientConfig.VIP_RETRY_INTERVAL_MINUTES.get(), 1, 1440)
                .setDefaultValue(10)
        ...
        vipCat.addEntry(entryBuilder.startTextDescription(Component.literal(statusBuilder.toString())).build());
        ...
        lyricCat.addEntry(entryBuilder.startTextDescription(Component.translatable("netmusic_kugou.config.lyric_display_desc"))
                .build());
        lyricCat.addEntry(entryBuilder.startBooleanToggle(Component.translatable("netmusic_kugou.config.show_translation"), ClientConfig.LYRIC_SHOW_TRANSLATION.get())
                ...
                .build());
        lyricCat.addEntry(entryBuilder.startBooleanToggle(Component.translatable("netmusic_kugou.config.show_romaji"), ClientConfig.LYRIC_SHOW_ROMAJI.get())
                .setDefaultValue(false)
